...
public class TelegramService {
    ...
    public void editReplyMarkup(Long chatId, Integer messageId, InlineKeyboardMarkup keyboard) {
        ...
        try {
            ...
            log.error("Failed to edit reply markup message ID: {} for chat ID: {}", messageId, chatId, e);
        }
    }
    ...
    public void deleteMessage(Long chatId, Integer messageId) {
        ...
        try {
            ...
            log.error("Failed to delete message ID: {} for chat ID: {}", messageId, chatId, e);
        }
    }

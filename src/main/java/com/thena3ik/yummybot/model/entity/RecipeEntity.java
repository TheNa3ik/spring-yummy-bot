...
import com.thena3ik.yummybot.model.dto.UnitInfo;
...
public class RecipeEntity {
    ...
    public RecipeEntity(Recipe details) {
        this.id = details.id();
        updateWithDetails(details);
    }

    public void updateWithDetails(Recipe details) {
        this.setTitle(details.title());
        this.setImage(details.image());

...
public class GlobalExceptionHandler {
    ...
    public GlobalExceptionHandler(TelegramService telegramService, UserService userService, LocaleService localeService) {
    ...
    public void handle(Exception e, Update update) {
        ...
        try {
            ...
            if (chatId != 0L) {
                ...
                String errorMessage = localeService.getMessage("general.error.generic", lang);
